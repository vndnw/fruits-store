...
<head>
    ...
    <title>Xobbee - Edit Voucher</title>
...
<body>
    <div class="wrapper">
        ...
        <article class="article">
            <h1>Edit Voucher</h1>
            <form action="/edit-voucher" method="post">
                <input type="hidden" name="voucher_id" value="VOUCHER_ID"> <!-- Replace with actual voucher ID -->

                <div class="form-group">
                    <label for="voucher-code">Mã giảm giá</label>
                    <input type="text" id="voucher-code" name="voucher_code" value="VOUCHER_CODE" required>
                </div>

                <div class="form-group">
                    <label for="description">Mô tả</label>
                    <textarea id="description" name="description" required>VOUCHER_DESCRIPTION</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="valid-from" name="valid_from" value="VALID_FROM_DATE" required>
                </div>

                <div class="form-group">
                    <label for="valid-to">Hợp lệ đến</label>
                    <input type="date" id="valid-to" name="valid_to" value="VALID_TO_DATE" required>
                </div>
